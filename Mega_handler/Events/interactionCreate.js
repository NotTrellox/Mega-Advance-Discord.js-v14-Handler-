...
client.on('interactionCreate', async interaction => {
  ...
  try {
    ...
    if (slashCommand.guildOnly) {
      const private = client.config.SERVER_ID.OFFICIAL
    ...
    await slashCommand.run(client, interaction);
     if (client.config.SETTINGS.LogsSystem.CommandChannel && client.setting.System.COMMANDS_LOGS) await client.channels.cache.get(client.config.SETTINGS.LogsSystem.CommandChannel).send({
          embeds: [new EmbedBuilder()
